            ...
            ControllerFeature feature)
        {
            ...
            genericApiConfig
                ...
                .ForEach(controllerType =>
                {
                    ...
                    genericApiConfig
                        .Controllers
                        .Where(p => p.AssemblyQualifiedName.Equals(
                            controllerType.AssemblyQualifiedName,
                        ...
                        .ToList()
                        .ForEach(typeController =>
                        {
                            if (typeController == null ||
                                typeController.Tk == null ||
                                typeController.Id == null)
                            {
                                return;
                            }

                            feature.Controllers.Add(
                                controllerType.MakeGenericType(typeController.Tk, typeController.Id).GetTypeInfo());
                        });
                });
        }
    }
