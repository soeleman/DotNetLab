...
namespace Microsoft.AspNetCore.Builder
{
        ...
        where TK : class, new()
    {
        ...
        public async Task<(bool state, TK createdData)> Create(
            TK newData)
        {
            if (newData == null)
            {
        ...
        public async Task<(bool state, TK currentData)> ReadByKey(
            T key)
        {
            if (key == null)
            {
        ...
        public async Task<(bool state, TK updatedData)> Update(
            T key,
            TK updateData,
            string[] excludes)
        {
        ...
        public async Task<(bool state, TK deletedData)> Delete(
            T key)
        {
            if (key == null)
            {
